/*
https://www.geeksforgeeks.org/dsa/maximize-the-sum-of-a-subsequence-from-an-array-based-on-given-conditions/?utm_source=chatgpt.com
...
ll fun(ll pos, ll cnt){
    ...
    ll take = cnt * v[pos] + fun(pos+1, cnt+1);
    ll notTake = fun(pos+1, cnt);
    return dp[pos][cnt] = max(take, notTake);
}
// Code
void solve()
{
